...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	{0, 20, (IOCON_FUNC2 | IOCON_MODE_PULLUP)}, /* SD_CMD */
	{0, 22, (IOCON_FUNC2 | IOCON_MODE_PULLUP)}, /* SD_DAT[0] */
	{1, 7,  (IOCON_FUNC2 | IOCON_MODE_PULLUP)}, /* SD_DAT[1] */
	{1, 11, (IOCON_FUNC2 | IOCON_MODE_PULLUP)}, /* SD_DAT[2] */
	{1, 12, (IOCON_FUNC2 | IOCON_MODE_PULLUP)}, /* SD_DAT[3] */
